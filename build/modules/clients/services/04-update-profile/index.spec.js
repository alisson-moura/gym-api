...
(0, vitest_1.describe)('UseCase: Update Account', function () {
    (0, vitest_1.beforeEach)(function () {
        sut = new _1.UpdateAccount(fakeClientRepository);
        fakeRequest = {
            id: 1,
            name: 'Jonh Doe',
            email: 'jonh@mail.com',
    ...
    (0, vitest_1.test)('Deve retornar um erro caso o valor de um ou mais desses campos [id, name, email, gender] sejam nulos', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
    ...
    (0, vitest_1.test)('Deve retornar um erro caso não seja encontrado um usuário com o [id] fornecido', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, vitest_1.test)('Deve retornar um erro caso o [email] já esteja em uso por outro cliente diferente do cliente informado', function () { return __awaiter(void 0, void 0, void 0, function () {
        var updateClient, anotherClient, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    updateClient = fakeClient();
                    anotherClient = fakeClient();
                    anotherClient.id = 2;
                    vitest_1.vi.spyOn(fakeClientRepository, 'findById').mockImplementationOnce(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    ...
    (0, vitest_1.test)('Deve retornar um erro caso o [badge] seja fornecido  e já esteja em uso por outro cliente diferente do cliente informado', function () { return __awaiter(void 0, void 0, void 0, function () {
        var updateClient, anotherClient, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, vitest_1.test)('Deve retornar os dados do client atualizado', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    vitest_1.vi.spyOn(fakeClientRepository, 'update').mockImplementationOnce(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                        return [2 /*return*/, fakeClient()];
                    }); }); });
                    return [4 /*yield*/, sut.execute(fakeRequest)];
                case 1:
                    result = _a.sent();
                    (0, vitest_1.expect)(result).toBeInstanceOf(client_1.Client);
                    return [2 /*return*/];
            }
        });
    }); });
