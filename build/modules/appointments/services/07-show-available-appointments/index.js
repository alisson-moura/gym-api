...
exports.ShowAvailableAppointments = void 0;
var schedule_1 = require("../../../../models/schedule");
var AppError_1 = require("../../../../providers/AppError");
var ShowAvailableAppointments = /** @class */ (function () {
    function ShowAvailableAppointments(appointmentRepository, dateProvider) {
        this.appointmentRepository = appointmentRepository;
        this.dateProvider = dateProvider;
    }
    ShowAvailableAppointments.prototype.execute = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var date, day, schedule, appoitments, appLimit, availableHours;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (this.dateProvider.isBefore(date, day)) {
                            return [2 /*return*/, new AppError_1.AppError('Date provided is invalid')];
                        }
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, availableHours];
                }
            });
        });
    };
...
exports.ShowAvailableAppointments = ShowAvailableAppointments;
